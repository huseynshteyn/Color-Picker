...
def FindColor():
    ...
    pallete=ct.get_palette(11)
    
    color1=f"#{pallete[0][0]:02x}{pallete[0][1]:02x}{pallete[0][2]:02x}"
    color2=f"#{pallete[1][0]:02x}{pallete[1][1]:02x}{pallete[1][2]:02x}"
    color3=f"#{pallete[2][0]:02x}{pallete[2][1]:02x}{pallete[2][2]:02x}"
    color4=f"#{pallete[3][0]:02x}{pallete[3][1]:02x}{pallete[3][2]:02x}"
    color5=f"#{pallete[4][0]:02x}{pallete[4][1]:02x}{pallete[4][2]:02x}"
    color6=f"#{pallete[5][0]:02x}{pallete[5][1]:02x}{pallete[5][2]:02x}"
    color7=f"#{pallete[6][0]:02x}{pallete[6][1]:02x}{pallete[6][2]:02x}"
    color8=f"#{pallete[7][0]:02x}{pallete[7][1]:02x}{pallete[7][2]:02x}"
    color9=f"#{pallete[8][0]:02x}{pallete[8][1]:02x}{pallete[8][2]:02x}"
    color10=f"#{pallete[9][0]:02x}{pallete[9][1]:02x}{pallete[9][2]:02x}"
...
hex1=Label(colors, text="#afb83b", fg="#000", font="arial 12 bold", bg="white")
hex1.place(x=60, y=265)
...
hex10=Label(colors2, text="#05FF4F", fg="#000", font="arial 12 bold", bg="white")
hex10.place(x=60, y=215)

hex1=Label(colors2, text="#afb83b", fg="#000", font="arial 12 bold", bg="white")
hex1.place(x=60, y=265)
